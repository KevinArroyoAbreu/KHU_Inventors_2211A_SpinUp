...
// purePursuit.cpp
//-----------------------------------------------------------------
/*This file contains data, variables, and calculations for performing
pure pursuit paths on the drivetrain.*/
//*****************************************************************
...
// you can also change the Kp constant which is located at line 127
currentPos = [0, 0]
currentHeading = 0
lastFoundIndex = 0
lookAheadDis = 0.8
...
def pure_pursuit_animation (frame) :
  ...
  //               rpm   /s  circ(3.25" wheels)   feet
  maxLinVelfeet = 600 / 60 * pi*2.64 / 12
  //               rpm   /s  center angle (10in width)   deg
  maxTurnVelDeg = 600 / 60 * pi*2.64 / 10 *180/pi
